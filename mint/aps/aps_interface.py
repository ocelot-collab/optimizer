...
class APSMachineInterface(MachineInterface):
    ...
    def get_quick_add_devices(self):
        ...
        devs = OrderedDict([
            ("L3 Charge Opt NoSteering ", ["L1:RG2:QM1:CurrentAO", "L1:RG2:QM2:CurrentAO","L1:RG2:QM3:CurrentAO","L1:RG2:QM4:CurrentAO",
                                "L1:RG2:SC1:VL:CurrentAO", "L1:RG2:SC2:HZ:CurrentAO","L1:RG2:SC2:VL:CurrentAO", "L1:RG2:SC3:HZ:CurrentAO",
                                 "L1:RG2:SC3:VL:CurrentAO", "L1:QM3:CurrentAO", "L1:QM4:CurrentAO", "L1:QM5:CurrentAO"]),
            ("L3 Charge Opt-All ", ["L1:RG2:QM1:CurrentAO", "L1:RG2:QM2:CurrentAO","L1:RG2:QM3:CurrentAO","L1:RG2:QM4:CurrentAO",
                                ...
                                "L2:SC1:HZ:PS:setCurrentAO", "L2:SC1:VL:PS:setCurrentAO","L2:SC2:HZ:PS:setCurrentAO","L2:SC2:VL:PS:setCurrentAO",
                                "L2:SC3:HZ:PS:setCurrentAO","L2:SC3:VL:PS:setCurrentAO","L2:SC4:HZ:PS:setCurrentAO","L2:SC4:VL:PS:setCurrentAO",
                                "L3:SM:SC1:HZ:PS:setCurrentAO","L3:SM:SC1:VL:PS:setCurrentAO","L3:SC2:HZ:PS:CurrentAO","L3:SC2:VL:PS:CurrentAO"]),
            ...
            ("RG1", ["L1:RG1:QM3:CurrentAO","L1:RG1:QM2:CurrentAO","L1:RG1:QM1:CurrentAO"]),
    ...
    def write_data(self, method_name, objective_func, devices=[], maximization=False, max_iter=0):
        ...
        if objvals-vals==2:
            #for rcds optimizer, the objective has 2 more values than the variables
            #the first 2 and the last of objective should be removed (first point is redundant)
            start=2
            end=-1
            objective_func.niter -=3
       ...
       #     self.data[key2] = self.data.pop(key)
        ...
        sddsData.defineSimpleParameter("RCDSFile",sddsData.SDDS_STRING)
        ...
        rcdsFile='/usr/local/oag/3rdParty/OcelotOptimizer-dev/op_methods/rcds.py'
        ...
        sddsData.setParameterValue('RCDSFile',os.readlink(rcdsFile),1)
